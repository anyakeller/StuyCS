...
2015-03-31
 ...
 end of the word and repeat until you come across a vowel. Then add ay.
...
v.1.1
Anya made the code work with punctuation (the new translate) and fixed a bunch of bugs
'''
...
#new and updated version by Anya!
def translate(phrase):
    count = 0
    word = 0
    new = ''
...
'''
Iway ancay eakspay iglatinpay!!!
Areway youway away ineapplepay?
ometimessay Iway ikelay otay otatepay
Iway amway ethay eenquay ofway ibashay
'''
